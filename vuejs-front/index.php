      ...
      try
      {
        ...
        switch ($params[1]) {
          ...
          case 'faces':
            ...
            $og_image = "https://api.nendoroids-db.net/images/faces/".$rep['internalid']."/1/thumb";
            break;
          case 'face':
          ...
          case 'hairs':
            ...
            $og_image = "https://api.nendoroids-db.net/images/hairs/".$rep['internalid']."/1/thumb";
            break;
          case 'hair':
          ...
          case 'hands':
            ...
            $og_image = "https://api.nendoroids-db.net/images/hands/".$rep['internalid']."/1/thumb";
            break;
          case 'hand':
          ...
          case 'bodyparts':
            ...
            $og_image = "https://api.nendoroids-db.net/images/bodyparts/".$rep['internalid']."/1/thumb";
            break;
          case 'bodypart':
