  ...
  <div class="db-box" v-if="bodypart">
    ...
    <div class="row">
      ...
      <div class="col-md-4 col-sm-12 col-xs-12">
        <div class="box">
          <app-box-header title="Photo" collapsable="true" icon="fa-photo" editable="true" :editlink="'/bodypart/'+bodypart.internalid+'/edit/image'"></app-box-header>
...
export default {
  ...
  computed: {
    ...Vuex.mapGetters(['boxes', 'nendoroids', 'bodyparts', 'photos', 'photobodyparts', 'authenticated', 'viewvalidation', 'canedit']),
    bodypart () {
  ...
  methods: {
    ...
    loadhistory () {
      ...
      this.$http.get('bodypart/' + this.$route.params.id + '/history').then(response => {
