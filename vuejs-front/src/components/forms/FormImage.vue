          ...
          this.$http.post(posturl, formData).then(response => {
            switch (this.element) {
              ...
              case 'accessory':
                ...
                break
              case 'bodypart':
                this.addBodypartPicture({'internalid': this.$route.params.id, 'number': this.$route.params.number})
                break
              case 'face':
              ...
              case 'hair':
                ...
                break
              case 'hand':
                this.addHandPicture({'internalid': this.$route.params.id, 'number': this.$route.params.number})
                break
              case 'user':
