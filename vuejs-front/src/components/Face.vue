      ...
      <div class="col-md-12">
        <div class="box">
          <div class="box-header with-border">
            <h3 class="box-title">
              <router-link :to="'/face/'+face.internalid+'/edit'" class="btn btn-xs bg-blue pull-right" v-if="canedit"><i class="fa fa-edit"></i> Edit</router-link>
...
export default {
  ...
  computed: {
    ...Vuex.mapGetters(['boxes', 'nendoroids', 'faces', 'photos', 'photofaces', 'authenticated', 'viewvalidation', 'canedit']),
    face () {
  ...
  methods: {
    ...Vuex.mapActions(['collectFace', 'uncollectFace', 'validateFace', 'unvalidateFace']),
    ...
    loadhistory () {
      ...
      this.$http.get('face/' + this.$route.params.id + '/history').then(response => {
