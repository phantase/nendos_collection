<template>
  <div class="box-header with-border">
    ...
    <div class="box-tools pull-right" v-if="collapsable || editable">
      <router-link :to="otherlink" class="btn btn-box-tool" data-toggle="tooltip" :title="othername" v-if="otherable"><i :class="'fa '+othericon"></i></router-link>
...
export default {
  name: 'BoxHeader',
  props: ['title', 'collapsable', 'collapsed', 'icon', 'editable', 'editlink', 'otherable', 'otherlink', 'othericon', 'othername'],
  data () {
    return {
    }
  },
