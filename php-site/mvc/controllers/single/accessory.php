...
if( isset($_GET['accessory_internalid']) ){
  ...
  if($resultInfo[0]=="00000"){
    ...
    $og_title = "Accessory: " . $accessory['accessory_type'] 
              . " from " . $accessory['box_category'] 
              . ((isset($accessory['box_number']) && strlen($accessory['box_number'])>0)?" #".$accessory['box_number']:"") 
              . " - " . $accessory['box_name'];
    $og_description = "An accessory described in Nendoroids-db, " 
                    . $accessory['accessory_type'] 
                    . " [" . $accessory['accessory_main_color'] . ((isset($accessory['accessory_other_color']) && strlen($accessory['accessory_other_color'])>0)?"/".$accessory['accessory_other_color']:"") . "] - " 
