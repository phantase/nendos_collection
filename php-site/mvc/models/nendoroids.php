...
function get_allNendoroids($order="db_creationdate",$direction="DESC",$userid=null)
{
  ...
  $req = $bdd->prepare("SELECT n.internalid AS nendoroid_internalid,
                        ...
                        LEFT JOIN (
                          ...
                          WHERE userid = :userid
                          ) AS uc ON n.internalid = uc.nendoroidid
...
function get_singleNendoroid($nendoroid_internalid,$userid=null)
{
  global $bdd;
...
function get_boxNendoroids($box_internalid,$userid=null)
{
  global $bdd;
