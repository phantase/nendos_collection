              ...
              <div class="row" id="menu_area" style="display:none;" sortdest="hands">
                ...
                <div class="12u">
                  ...
                  <div class="select-wrapper">
                    <select name="order" id="order">
                      <optgroup label="Hand">
                        <option value="hand_posture" <?= ($selected_order=="hand_posture")?"selected":""; ?>>Posture</option>
                        <option value="hand_skin_color" <?= ($selected_order=="hand_skin_color")?"selected":""; ?>>Skin color</option>
                        <option value="hand_leftright" <?= ($selected_order=="hand_leftright")?"selected":""; ?>>Left/Right</option>
                      </optgroup>
