              ...
              <div class="row uniform">
                  <div class="4u 12u$(medium)">
                    <div class="select-wrapper">
                      <select name="new_face_box_id" id="new_face_box_id">
<?php
  if(count($boxes)>1){
?>
...
?>
                  ...
                  <div class="4u$ 12u$(medium)">
                    <div class="select-wrapper">
                      <select name="new_face_nendoroid_id" id="new_face_nendoroid_id">
<?php
...
?>
                  ...
                  <div class="4u$ 12u$(medium)">
                    <input type="color" name="new_face_eyes_color_hex" id="new_face_eyes_color_hex" placeholder="Eyes color code" />
                  </div>
                  <div class="4u 12u$(medium)">
                  ...
                  <div class="4u$ 12u$(medium)">
                    <input type="color" name="new_face_skin_color_hex" id="new_face_skin_color_hex" placeholder="Skin color code" />
                  </div>
                  <div class="4u 12u$(medium)">
                    <div class="select-wrapper">
