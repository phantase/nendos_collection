              ...
              <div class="row" id="menu_area" style="display:none;" sortdest="accessories">
                  ...
                  <div class="select-wrapper">
                    <select name="order" id="order">
                      <optgroup label="Accessory">
                        <option value="accessory_type" <?= ($selected_order=="accessory_type")?"selected":""; ?>>Type</option>
                        <option value="accessory_main_color" <?= ($selected_order=="accessory_main_color")?"selected":""; ?>>Main color</option>
                        <option value="accessory_other_color" <?= ($selected_order=="accessory_other_color")?"selected":""; ?>>Other color</option>
                      </optgroup>
