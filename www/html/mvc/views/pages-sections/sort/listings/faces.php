              ...
              <div class="row" id="menu_area" style="display:none;" sortdest="faces">
                ...
                <div class="12u">
                  ...
                  <div class="select-wrapper">
                    <select name="order" id="order">
                      <optgroup label="Face">
                        <option value="face_eyes_color" <?= ($selected_order=="face_eyes_color")?"selected":""; ?>>Eyes color</option>
                        <option value="face_skin_color" <?= ($selected_order=="face_skin_color")?"selected":""; ?>>Skin color</option>
                        <option value="face_sex" <?= ($selected_order=="face_sex")?"selected":""; ?>>Sex</option>
                      </optgroup>
