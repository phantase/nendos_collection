                ...
                <div class="12u">
                  ...
                  <div class="select-wrapper">
                    <select name="order" id="order">
                      <optgroup label="Face">
                        <option value="eyes_color" <?= ($selected_order=="eyes_color")?"selected":""; ?>>Eyes color</option>
                        <option value="skin_color" <?= ($selected_order=="skin_color")?"selected":""; ?>>Skin color</option>
                        <option value="sex" <?= ($selected_order=="sex")?"selected":""; ?>>Sex</option>
                      </optgroup>
