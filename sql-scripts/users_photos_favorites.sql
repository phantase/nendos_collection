-- Create the table
CREATE TABLE `users_photos_favorites` (
...
-- Add the indexes
ALTER TABLE `users_photos_favorites`
...
-- Add the constraints
ALTER TABLE `users_photos_favorites`
  ADD CONSTRAINT `users_photos_favorites_ibfk_1` FOREIGN KEY (`userid`) REFERENCES `users` (`internalid`),
  ADD CONSTRAINT `users_photos_favorites_ibfk_2` FOREIGN KEY (`photoid`) REFERENCES `photos` (`internalid`);
