-- Create the table
CREATE TABLE `users_accessories_favorites` (
...
-- Add the indexes
ALTER TABLE `users_accessories_favorites`
...
-- Add the constraints
ALTER TABLE `users_accessories_favorites`
  ADD CONSTRAINT `users_accessories_favorites_ibfk_1` FOREIGN KEY (`userid`) REFERENCES `users` (`internalid`),
  ADD CONSTRAINT `users_accessories_favorites_ibfk_2` FOREIGN KEY (`accessoryid`) REFERENCES `accessories` (`internalid`);
