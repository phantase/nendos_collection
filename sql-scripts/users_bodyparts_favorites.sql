-- Create the table
CREATE TABLE `users_bodyparts_favorites` (
...
-- Add the indexes
ALTER TABLE `users_bodyparts_favorites`
...
-- Add the constraints
ALTER TABLE `users_bodyparts_favorites`
  ADD CONSTRAINT `users_bodyparts_favorites_ibfk_1` FOREIGN KEY (`userid`) REFERENCES `users` (`internalid`),
  ADD CONSTRAINT `users_bodyparts_favorites_ibfk_2` FOREIGN KEY (`bodypartid`) REFERENCES `bodyparts` (`internalid`);
