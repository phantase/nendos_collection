-- Create the table
CREATE TABLE `users_nendoroids_collection` (
...
-- Add the indexes
ALTER TABLE `users_nendoroids_collection`
...
-- Add the constraints
ALTER TABLE `users_nendoroids_collection`
  ADD CONSTRAINT `users_nendoroids_collection_ibfk_1` FOREIGN KEY (`userid`) REFERENCES `users` (`internalid`),
  ADD CONSTRAINT `users_nendoroids_collection_ibfk_2` FOREIGN KEY (`nendoroidid`) REFERENCES `nendoroids` (`internalid`);
